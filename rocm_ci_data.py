...
# Generated: 2026-06-22 04:29 AM PDT
...
COMPONENTS = [
    (
        ...
        "linux-gfx942-1gpu-core42-ossci-rocm\n(alternate pool: linux-gfx942-1gpu-ccs-ossci-rocm, linux-gfx942-1gpu-ossci-rocm)",
        "—",
        "—",
        "standard",
...
RUNNER_DATA = [
    ...
    (
        ...
        "1",
        "PR · postsubmit · nightly",
        "Weighted alternate pool (weight=0.117)"
    ),
    (
        ...
        "1",
        "PR · postsubmit · nightly",
        "Weighted alternate pool (weight=0.147)"
    ),
    (
...
TIER_DATA = [
    ...
    (
        "ASAN / TSAN",
        "multi_arch_ci_asan.yml (schedule + push)",
...
INFERENCEMAX_DATA = [
    (
        ...
        "sglang",
        False,
        "lmsysorg/sglang:v0.5.12-rocm700-mi35x"
    ),
    (
    ...
    (
        ...
        "atom",
        False,
        "rocm/atom:rocm7.2.3_ubuntu24.04_py3.12_pytorch_release_2.10.0_atom20260511"
    ),
    (
    ...
    (
        ...
        "sglang",
        False,
        "lmsysorg/sglang:v0.5.12-rocm700-mi30x"
    ),
    (
    ...
    (
        ...
        "sglang",
        False,
        "lmsysorg/sglang-rocm:v0.5.10rc0-rocm720-mi35x-20260415"
    ),
    (
    ...
    (
        "glm5.1-fp4-mi355x-sglang-agentic_internal",
        "amd/GLM-5.1-MXFP4",
        "glm5.1",
        "mi355x",
        "fp4",
    ...
    (
        ...
        "sglang-disagg",
        True,
        "lmsysorg/sglang-rocm:v0.5.10.post1-rocm720-mi35x-20260501"
    ),
    (
    ...
    (
        ...
        "sglang",
        False,
        "rocm/sgl-dev:rocm720-mi35x-8c3b5aa-20260521-DSv4"
    ),
    (
        ...
        "vllm",
        False,
        "vllm/vllm-openai-rocm:nightly-4f940896a32c9e2a0eba7f50d521bf5f6b4de458"
    ),
    (
        ...
        "atom",
        False,
        "rocm/atom-dev:nightly_202605130853"
    ),
    (
...
INFERENCE_RUNNERS = {'amd': {'mi300x': ['mi300x-amds_00', 'mi300x-amds_01', 'mi300x-amds_02', 'mi300x-amds_03', 'mi300x-amds_04', 'mi300x-amds_05', 'mi300x-amds_06', 'mi300x-amds_07', 'mi300x-amds_08'], 'mi300x-disagg': ['mi300x-amds_06', 'mi300x-amds_07', 'mi300x-amds_08'], 'mi325x': ['mi325x-amds_00', 'mi325x-amds_01', 'mi325x-amds_02', 'mi325x-amds_03', 'mi325x-amds_04', 'mi325x-amds_05', 'mi325x-amds_06', 'mi325x-amds_07', 'mi325x-amds_08'], 'mi325x-disagg': ['mi325x-amds_00', 'mi325x-amds_01', 'mi325x-amds_02', 'mi325x-amds_03', 'mi325x-amds_06', 'mi325x-amds_07', 'mi325x-amds_08'], 'mi355x': ['mi355x-amds_0', 'mi355x-amds_1', 'mi355x-amds_2', 'mi355x-amds_3', 'mi355x-amds_4', 'mi355x-amds_5', 'mi355x-amds_6', 'mi355x-amds_7', 'mi355x-amds_8'], 'mi355x-disagg': ['mi355x-amds_6',