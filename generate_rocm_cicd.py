...
TIER_DATA = [
    ...
    ("CI Nightly",
     "multi_arch_ci_asan.yml (schedule) + test_pytorch_wheels_full.yml (workflow_dispatch)",
     ...
     "Ubuntu 22.04 LTS", "Windows Server 2022"),
    ("ASAN / TSAN",
     "ASAN + TSAN: multi_arch_ci_asan.yml — push to main + schedule + workflow_dispatch\n(consolidated the retired ci_asan.yml / ci_tsan.yml)",
     "02:00 UTC daily — cron: 0 02 * * *\n+ on push to main & on-demand",
     "quick = smoke/sanity only\n(asan/host-asan/tsan build variants from amdgpu_family_matrix.py, via multi_arch_ci_linux.yml — sanitizer-instrumented build of post-commit suite)",
...
WH_DATA = [
    ...
    ("PyTorch","2.10 (default CI pin)","3.10, 3.11, 3.12, 3.13, 3.14",
     ...
     "Linux: gfx94X, gfx950, gfx90a, gfx103X, gfx110X, gfx1150, gfx1151, gfx1153, gfx120X\nWindows: gfx1151, gfx110X, gfx103X, gfx120X",
     "Linux: gfx900, gfx906, gfx908, gfx101X",
     "CI pipeline (post-merge push to release/2.10) + 02:00 UTC daily (multi_arch_ci_asan.yml)",
     "Linux: azure-linux-scale-rocm\nWindows: azure-windows-scale-rocm", _WH_SMOKE_PT,
    ...
    ("PyTorch","nightly","3.10, 3.11, 3.12, 3.13, 3.14",
     ...
     "Linux: gfx94X, gfx950, gfx90a, gfx103X, gfx110X, gfx1150, gfx1151, gfx1153, gfx120X\nWindows: gfx1151, gfx110X, gfx103X, gfx120X",
     "Linux: gfx900, gfx906, gfx908, gfx101X",
     "02:00 UTC daily (multi_arch_ci_asan.yml) + on push to pytorch/pytorch main",
     "Linux: azure-linux-scale-rocm\nWindows: azure-windows-scale-rocm", _WH_SMOKE_PT,
     "Triton pin from pytorch/.ci/docker/ci_commit_pins/triton.txt"),
    ("JAX","0.8.0","3.11, 3.12, 3.13, 3.14",
     "Linux: Ubuntu 22.04 LTS",
...
_DS_ROWS = [
    ...
    ("", _DS_BLUE,
     ...
     "Nightly schedule (cron '0 02 * * *') + ASAN sanitizer test matrix",
     "https://github.com/ROCm/TheRock/blob/main/.github/workflows/multi_arch_ci_asan.yml"),
    ("", _DS_BLUE,
     "pre-commit.yml",
     "Pre-commit tier — lint/format checks on PR + push to main",
     "https://github.com/ROCm/TheRock/blob/main/.github/workflows/pre-commit.yml"),
    ("", _DS_BLUE,
     "multi_arch_ci.yml",
     "Main CI — push to main / release branches + workflow_dispatch (Linux + Windows GPU families)",
     "https://github.com/ROCm/TheRock/blob/main/.github/workflows/multi_arch_ci.yml"),
    ("", _DS_BLUE,
     "multi_arch_ci_linux.yml / _windows.yml",
     "Reusable per-platform CI sub-workflows (workflow_call)",
     "https://github.com/ROCm/TheRock/blob/main/.github/workflows/multi_arch_ci_linux.yml"),
    ("", _DS_BLUE,
     "multi_arch_release.yml",
     "Release pipeline (workflow_call: dev / nightly / prerelease)",
